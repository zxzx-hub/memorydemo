...
- **修改模块**：`backend/src/service/auth`、`backend/src/service/api/dependencies.py`、`backend/src/service/core`、`backend/src/service/infrastructure/db`、`backend/src/service/infrastructure/redis`、`backend/src/service/main.py`。
...
- **修改模块**：`backend/src/service/domain`、`backend/src/service/ports/repositories.py`、`backend/src/service/ports/unit_of_work.py`、`backend/src/service/infrastructure/db/models`、`backend/src/service/infrastructure/db/repositories`、`migrations`。
...
- **修改模块**：`backend/src/service/services/memory_service.py`、事件/工作记忆 Repository、exact idempotency 支持、API 路由。
...
- **修改模块**：`backend/src/service/services/consolidate_once.py`、checkpoint/evidence/candidate Repository、UoW、checkpoint prompt。
...
- **修改模块**：`backend/src/service/services/candidate_governance.py`、长期主记录/版本 Repository、`JobDispatcher`。
...
- **修改模块**：`backend/src/service/services/retrieval_service.py`、`context_compiler.py`、exact/vector/graph Port 与适配器。
...
- **修改模块**：`backend/src/service/services/lifecycle_service.py`、生命周期/配额/删除 Repository、各索引清理适配器。
...
- **修改模块**：`backend/src/service/ports/llm_client.py`、`backend/src/service/infrastructure/llm`、`backend/src/service/prompts`。
